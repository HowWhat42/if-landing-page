const Service = ({ title, texts, img, color, id }) => {
    ...
    return (
        <div className='flex flex-col py-8 md:py-16 xl:py-48 px-8 lg:px-12 xl:px-16'>
            ...
            <div className={`flex flex-col lg:flex-row justify-between ${isEven ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className={`flex flex-col justify-between ${isEven ? 'items-start' : 'items-end'}`}>
                    <div className="wireframes flex">
                        ...
                        <p className='font-clash text-9xl invisible lg:visible lg:text-10xl xl:text-230 font-bold text-transparent wireframe absolute opacity-60 blur-[1px]' style={{ WebkitTextStrokeColor: color, WebkitTextStrokeWidth: '0.2rem' }}>0{id}</p>
                        <p className='font-clash text-9xl invisible lg:visible lg:text-10xl xl:text-230 font-bold text-transparent wireframe absolute opacity-40 blur-[2px]' style={{ WebkitTextStrokeColor: color, WebkitTextStrokeWidth: '0.2rem' }}>0{id}</p>
                    </div>
