...
const Hero = () => {
    ...
    useEffect(() => {
        window.addEventListener('mousemove', moveWireframes)

        return () => window.removeEventListener('mousemove', moveWireframes)
    }, [mousePosition])

    return (
        <div className='h-screen flex justify-center xl:justify-start items-center'>
            <div className='hidden xl:flex logo h-screen w-1/2 items-center justify-center'>
            ...
            <div className='font-clash md: flex flex-col text-center animate-fade-in'>
